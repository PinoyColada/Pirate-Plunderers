...
//Calls html index file for canvos, score, and deminsions
...
{    this.position = {
        ...
        for (let x = 0; x < cols; x++){
            ...
            this.pirates.push(new Pirate({position: {
                x: x * 35,
                y: y * 40
            }
        })
...
//Listeners for when controls are used.
...
//Listeners for when controls are not used.
